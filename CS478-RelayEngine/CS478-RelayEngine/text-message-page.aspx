...
<head runat="server">
    <script type ="text/javascript">
        function count(txt)
        {
            var lbl = document.getElementById("Label7");
            lbl.innerHTML = "Message (160 characters max) " + txt.value.length + "/160";
        }
    </script>
    <title></title>
</head>
<body style="height: 385px">
    ...
    <div style="text-align:center">    
        ...
        <div style="text-align:center">
            ...
            <br />
            <asp:TextBox ID="TextBox1" runat="server" Height="117px" Rows="5" TextMode="MultiLine" Width="383px" onkeyup="count(this)" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        </div>
        <div style="text-align:center">
